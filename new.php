	...
	<td align=center valign=top>
		...
		<FORM name=hopeFM onSubmit="return chkFM();" method="post" action="new.php">
			...
			<td align=center valign=top>
				...
				<table border=0 cellpadding=0 cellspacing=0 width=608>
				<tr>
				<td><textarea cols="90" rows="5" style='color:#505050;font-size:12px;' align="left" onKeyDown="textCounter(this.form.messages,this.form.freeLength,120);" onKeyUp="textCounter(this.form.messages,this.form.freeLength,120);" name="messages" wrap="physical"></textarea></td>
				</tr>
				<tr><td height=33 class=f12_5050>您的署名：<input type=text name=singnature maxlength="10" value="" onKeyDown="javascript:viewsign.innerHTML=this.form.singnature.value" onKeyUp="javascript:viewsign.innerHTML=this.form.singnature.value"></td></tr>
				</table>
